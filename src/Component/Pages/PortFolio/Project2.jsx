        ...
        <section className="dark:text-gray-900">
          <div className="container px-4 py-16 mx-auto space-y-8 lg:max-w-3xl">
            <div>
              ...
              <a
                href="https://keen-croquembouche-1ee51e.netlify.app/"
                target="_blank"
              ...
              <a
                ...
                href="https://github.com/najima1/furniture-client-side-repository.git"
                target="_blank"
                ...
                <ul className="space-y-4">
                  <li className="space-y-1">
                    ...
                    <p className="ml-7 dark:text-gray-500 ">
                      ...
                      <br />
                      10. A Selar can add product as well as he can advertise .
                      <br />
                      11. A saler can delete product & can update
                      <br />
                      12. Admin can see all saler & can see all buyer.
                      <br />
                      13. Admin can delete saler of buyer.
                    </p>
                  </li>
                  <li className="space-y-1">
                    <div className="flex items-center space-x-2">
